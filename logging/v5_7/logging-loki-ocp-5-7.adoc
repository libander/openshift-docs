...
== Creating a secret for your object store

include::modules/logging-loki-storage.adoc[leveloffset=+1,lines=9..-1]
...
3. Verify that you see the *Infrastructure* logs grouped in *application*, *infrastructure*, and *audits* sections.
